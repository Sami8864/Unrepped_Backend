...
Route::group(['middleware' => 'auth:sanctum'], function () {
    ...
    Route::post('/cutOff', [ConversationController::class, 'chatCutOff']);
...
Route::group(['middleware' => 'auth:sanctum', 'prefix' => 'admin'], function () {
    ...
    Route::post('/del-flag', [PointsController::class, 'delete_flag']);
    Route::get('/notifications', [PointsController::class, 'nofic']);
    Route::post('/update-notifications', [PointsController::class, 'updateNofic']);
    Route::get('/transactions', [UserDetailController::class, 'getTransactions']);
